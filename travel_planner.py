        ...
        try:
            ...
            for chunk in response:
                if chunk.choices[0].delta.content is not None:
                    collected_chunk.append(chunk.choices[0].delta.content)
                    result.markdown("".join(collected_chunk))

            return "".join(collected_chunk)
...
def get_system_prompts():
    return {
        ...
        4. Provide recommendation for local cuisine and dining
        5. Include transportation tips and options
        6. Add cultural of historical context for key locations
        7. Offer packing tips based on the destination's climate""",
        "Travel Tips":"""You are a seasoned traveler who provides practical for smooth trips.
        Provide tips on:
...
def get_example_prompts():
    return {
        ...
        "Travel Tips": {
            ...
            5. "How do I handle language barries in non-English-speaking countries?""",
